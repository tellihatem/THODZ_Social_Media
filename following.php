<?php
// Redirect to new following page
header("Location: ./following_new.php");
exit;
 ...
 $image = new Image();
 $followers = $user->getFollowing($_SESSION['uid'],'user');
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <div class="navbar">
      ...
      <div class="navbar_center">
        ...
        <a href="following.php" class="active_icon" id="following_icon">
      ...
      <?php 
        if (is_array($followers)){
          foreach($followers as $follower){
            $follower_data = $user->getData($follower);

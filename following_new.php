...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-center">
            ...
            <a href="./following_new.php" class="nav-link active">
                <i class="fas fa-user-friends"></i>
            </a>
            <a href="./followers_new.php" class="nav-link">
    ...
    <div class="users-container">
        ...
        <div class="users-grid">
            <?php if (count($followingList) > 0): ?>
                ...
                ?>
                <div class="user-card">
                    <a href="./profile_new.php?uid=<?php echo $followingUser['uid']; ?>">
                    ...
                    <div class="user-card-actions">
                        ...
                        <a href="./chat_new.php?uid=<?php echo $followingUser['uid']; ?>" class="btn btn-secondary btn-icon">
            ...
            <?php else: ?>
                <div class="user-card" style="grid-column: 1 / -1; justify-content: center; padding: 40px;">
                    <div style="text-align: center;">
                        ...
                        <a href="./home_new.php" class="btn btn-primary" style="margin-top: 16px;">Discover People</a>
                    </div>
                </div>
            <?php endif; ?>
        </div>

...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-center">
            <a href="./home_new.php" class="nav-link active">
                <i class="fas fa-home"></i>
            </a>
            <a href="./following.php" class="nav-link">
                <i class="fas fa-user-friends"></i>
            </a>
            <a href="./users_chat.php" class="nav-link">
        ...
        <div class="navbar-right">
            ...
            <div class="dropdown-menu">
                ...
                <a href="./profile_new.php?tab=settings" class="dropdown-item">
    ...
    <div class="main-container">
        ...
        <aside class="sidebar">
            <nav class="sidebar-nav">
                ...
                <a href="./users_chat.php" class="sidebar-link">
                    <i class="fas fa-comments"></i>
                    <span>Messages</span>
                </a>
            </nav>
        ...
        <aside class="right-sidebar">
            <div class="sidebar-section">
                ...
                <?php if ($suggestedUsers && count($suggestedUsers) > 0): ?>
                    ...
                    ?>
                    <a href="./profile_new.php?uid=<?php echo $suggested['uid']; ?>" class="sidebar-link">

...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="navbar-center">
            ...
            <a href="./chat_new.php" class="nav-link active">
    ...
    <div class="chat-container">
        ...
        <div class="chat-sidebar" id="chatSidebar">
            ...
            <div class="chat-list" id="chatList">
                <?php if (is_array($allUsers) && count($allUsers) > 0): ?>
                    ...
                    ?>
                    <a href="./chat_new.php?uid=<?php echo $chatUser['uid']; ?>" 
        ...
        <div class="chat-main">
            ...
            <div class="chat-header">
                ...
                <a href="./profile_new.php?uid=<?php echo $chatWithId; ?>" class="chat-header-avatar">
                ...
                <div class="chat-header-actions">
                    ...
                    <a href="./profile_new.php?uid=<?php echo $chatWithId; ?>" class="chat-header-btn" title="Info">
    ...
    <script>
        ...
        function updateSidebarLastMessage(text, isImage = false, isAudio = false) {
            ...
            const activeItem = document.querySelector(`.chat-list-item[href="./chat_new.php?uid=${chatWithId}"]`);
            if (activeItem) {
